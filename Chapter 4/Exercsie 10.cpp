...
//Task here
/*
Напишите программу для игры  "Камень.  бумага.  ножницы'' .  Если  вы
...
стов) . Для  решения  поставленной  задачи  используйте  инструкцию
switch. Кроме того, машина должна давать случайные ответы (т.е. вы­
